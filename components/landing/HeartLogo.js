...
import { inkDraw, moonGlowPulse } from '../../lib/motion'
      ...
      <svg viewBox="0 0 64 64" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="heartLogoStroke" x1="8" y1="10" x2="56" y2="54" gradientUnits="userSpaceOnUse">
            <stop stopColor="#d4818f" />
            <stop offset="0.55" stopColor="#f7c6a8" />
            <stop offset="1" stopColor="#e6b8c9" />
          </linearGradient>
        ...
        {/* Stitched heart path (single thread) */}
        <motion.path
        ...
        {!reduceMotion && (
          <motion.g {...moonGlowPulse} style={{ transformOrigin: '32px 30px' }}>
            <circle cx="32" cy="30" r="12" fill="rgba(247,198,168,0.10)" />
          </motion.g>
        )}
      </svg>
    </span>
