...
/** Snappier transitions inside the logged-in app shell (chat, dashboard, etc.) */
...
/** Fast fade for login, register, terms, contact — no blur or layout shift */
export const marketingPageTransition = {
  ...
  exit: {
    opacity: 0,
    transition: { duration: 0.06, ease: ease.out },
  },
}
