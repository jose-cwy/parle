...
const DEFAULT_PROFILE = {
  ...
  mode_switch_count: 0,
  most_used_mode: 'Just listen',
  session_count: 0,
  average_session_length_messages: 0,
  repeat_sentiment_count: 0,
}

const WARM_MODES = new Set(['Comfort me first', 'Just listen', 'I just need to vent'])
const DIRECT_MODES = new Set(['Be honest with me', 'Help me understand what happened'])
const VALIDATION_MODES = new Set(['Just listen', 'I just need to vent'])
...
async function updateProfileAfterSession(userId, signals) {
  ...
  let mostUsedMode = profile.most_used_mode || 'Just listen'
