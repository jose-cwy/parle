const INJECTION_PATTERNS = [
  /ignore.{0,20}(previous|prior|all|your).{0,20}(instructions|prompt|rules)/i,
  /you are now.{0,20}(a|an|the)/i,
  /pretend.{0,20}(you are|to be|you're)/i,
  /act as.{0,20}(a|an|the|if)/i,
  /reveal.{0,20}(your|the).{0,20}(prompt|instructions|system)/i,
  /ignore.{0,20}(guidelines|restrictions|rules|limits)/i,
  /jailbreak/i,
  /dan mode/i,
  /developer mode/i,
]
...
const INJECTION_RESPONSE =
  "that's not something i'll do — i'm just here to listen. what's actually going on with you?"
