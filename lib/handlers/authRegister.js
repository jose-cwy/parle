...
async function handleRegister(req, res) {
  const guard = runApiPipeline(req, res, { tier: 'authStrict' })
  ...
  try {
    ...
    const result = await db.query(
      `INSERT INTO users (email, password, accepted_terms_at, accepted_terms_version, memory_enabled, personalisation_enabled, created_at, updated_at)
       VALUES ($1,$2,$3,$4,TRUE,TRUE,$5,$6)
       RETURNING id,email,preferred_name,accepted_terms_at,accepted_terms_version,memory_enabled,personalisation_enabled`,
